...
const SearchWord = props => {
  ...
  useEffect(() => {
    ...
    else if (definitionReturnedRef.current.success === undefined) setWordExists(true);
  }, [hasResults]);
      ...
      {!hasResults ? (
        <div>
          ...
          <div id='search-input-div'>
            ...
            ></input>
            <button className='search-btns first-search-btn' onClick={searchForWord} type='submit'>
              Search
            </button>
          </div>
        </div>
